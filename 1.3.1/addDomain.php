...
<!-- Mirrored from responsiweb.com/themes/preview/ace/1.3.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Jul 2014 17:07:42 GMT -->
<head>
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<meta charset="utf-8" />
		<title>Dashboard - EasyXampp</title>
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form id="addhost" class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Host Name </label>

										<div class="col-sm-9">
											<input type="text" id="addHostHostName" placeholder="hostName" class="col-xs-10 col-sm-5">
										</div>
									</div>
