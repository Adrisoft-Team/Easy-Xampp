...
<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - EasyXampp</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Xampp</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; RexAdrivan</h4>
							</div>
										...
										<div class="widget-main">
											...
											<form id="login">
												<fieldset>
													...
													<div id="login-error" class="hide alert alert-block alert-danger">
